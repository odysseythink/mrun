...
import (
	...
	"mlib.com/mrun/decimal"
	"mlib.com/mrun/strutils"
)
...
var genericMap = map[string]interface{}{
	...
	"nospace":      strutils.DeleteWhiteSpace,
	"initials":     initials,
	"randAlphaNum": randAlphaNumeric,
	"randAlpha":    randAlpha,
	"randAscii":    randAscii,
	"randNumeric":  randNumeric,
	"swapcase":     strutils.SwapCase,
	"shuffle":      strutils.Shuffle,
	"snakecase":    strutils.ToSnakeCase,
	"camelcase":    strutils.ToCamelCase,
	"kebabcase":    strutils.ToKebabCase,
	"wrap":         func(l int, s string) string { return strutils.Wrap(s, l) },
	"wrapWith":     func(l int, sep, str string) string { return strutils.WrapCustom(str, l, sep, true) },
