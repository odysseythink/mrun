...
type ARCCache[K comparable, V any] struct {
	...
	t1 ILRUCache[K, V]        // T1 is the LRU for recently accessed items
	b1 ILRUCache[K, struct{}] // B1 is the LRU for evictions from t1

	t2 ILRUCache[K, V]        // T2 is the LRU for frequently accessed items
	b2 ILRUCache[K, struct{}] // B2 is the LRU for evictions from t2
