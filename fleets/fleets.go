// Package fleets implements an efficient and reliable goroutine pool for Go.
//
// With fleets, Go applications are able to limit the number of active goroutines,
// recycle goroutines efficiently, and reduce the memory footprint significantly.
// Package fleets is extremely useful in the scenarios where a massive number of
...
var (
	...
	defaultLogger = Logger(log.New(os.Stderr, "[fleets]: ", log.LstdFlags|log.Lmsgprefix|log.Lmicroseconds))

	// Init an instance pool when importing fleets.
